	...
	<view class="container">
		<view class="main publicStyle">
			<view class="box">
				...
				<view class="size">
					<textarea v-model="textareaTextData" placeholder="请输入帮助信息"></textarea>
				</view>
			</view>
			...
			<view class="beizhu box">
				...
				<view class="select">
					<u-input inputAlign="right" type="text" placeholder="输入取货地点" border="none"
						v-model="quhuoAddress"></u-input>
				</view>
			</view>
			<u-line></u-line>
			...
			<view class="desc">
				<view class="box">
					<view class="title">
						...
						<text style="width: 80%;">下单的同学注意这里只用付跑腿费!最少跑腿费2元起，需要购买的东西详细写上去，跑腿范围仅限校园内或校园附近并把地址填清楚把需要办理的业务写上去交代清楚，并和业务员私信沟通清楚。</text>
					</view>
				</view>
				<u-line></u-line>
				<view class="box">
					<view class="title">
						<u-icon name="question-circle" size="25" color="#3796c8"></u-icon>
						<text style="width: 80%;">距离过长，无人接单建议增加金额</text>
					</view>
				</view>
			</view>
		</view>

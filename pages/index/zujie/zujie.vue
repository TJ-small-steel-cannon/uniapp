	...
	<view class="container">
		<view class="main publicStyle">
			<view class="box">
				...
				<view class="size">
					<textarea v-model="textareaTextData" placeholder="请输入要租借的物品及要求等"></textarea>
				</view>
			</view>
			...
			<view class="shouhuo box">
				...
				<view class="select" @click="leaseTimeState=true">
					{{leaseTime||"30分钟归还"}}
				</view>
			</view>
			<u-line></u-line>
			<view class="shouhuo box">
				...
				<view class="select" @click="estimatedDeliveryTimeState=true">
					{{estimatedDeliveryTime||"请选择交付时间"}}
				</view>
			</view>
			<u-line></u-line>
			...
			<u-picker :show="leaseTimeState" :columns="leaseTimeList" v-model="leaseTime" @confirm="setLeaseTime" @cancel="leaseTimeState=false"></u-picker>
			<u-datetime-picker :show="estimatedDeliveryTimeState" v-model="estimatedDeliveryTime" mode="time" @confirm="estimatedDeliveryTimeState=false" @cancel="estimatedDeliveryTimeState=false"></u-datetime-picker>
		</view>
		<view class="prompt publicStyle">
			<view class="desc">
				...
				<view class="box">
					<view class="title">
						<u-icon name="question-circle" size="25" color="#3796c8"></u-icon>
						<text style="width: 80%;">记得定时归还</text>
					</view>
				</view>
			</view>
		</view>
	...
	export default {
		data() {
			return {
				...
				// 租借时长数组
				leaseTimeList: [
					["30分钟", "1个小时", "1.5个小时", "3小时", "3.5小时", "4小时", "4.5小时", "5小时", "5.5小时", "6小时", "6.5小时", "7.5小时",
						"8小时"
					]
				],
				// 租借时长 弹窗状态
				leaseTimeState:false,
				// 预计交货时间
				estimatedDeliveryTime: "",
				// 预计交货时间弹窗显示状态
				estimatedDeliveryTimeState:false
			}
		},
		onShow() {
		...
		methods: {
			...
			setLeaseTime(e){
				console.log(e);
				this.leaseTime=e.value[0];
				this.leaseTimeState=false;
			},
			// 选中帮助选项
			...
			releaseOrder() {
				...
				let _data = {
					openid: openid,
					money: this.moneyNum,
					address: uni.getStorageSync("CacheItem"),
					notes: this.textareaTextData,
					startingPoint:this.leaseTime,
					end:this.estimatedDeliveryTime,
				}
				myRequest({
					url: "/zujie",
					method: "post",
